                ...
                <div class="col-lg-12">
					...
					<div class="col-md-6">	
							...
							<div class="form-group">
							  ...
							  <input type="email" name="EmailAddress" class="form-control" id="EmailAddress" placeholder="Enter Email Address"disabled>
							</div>

							<div class="form-group">
							  <label for="Address">Address:</label>
							  <input type="text" name="Address" class="form-control" id="Address" placeholder="Enter Address"disabled>
							</div>
							<div class="form-group">
    <!-- #region -->	 	<label for="City">City:</label>
    						<input type="text" name="City" class="form-control" id="City" placeholder="Enter City"disabled>
  							</div>
							<div class="form-group">
							  <label for="State">State:</label>
							  <input type="text" name="State" class="form-control" id="State" placeholder="Enter State" disabled>
							</div>
