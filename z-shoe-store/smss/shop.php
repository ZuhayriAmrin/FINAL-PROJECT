...
<marquee><font size=7> WELCOME TO ZACK SHOE SHOP</font></marquee>
    ...
    <div class="container">
		...
		<?php while($Rows = mysqli_fetch_array($Resulta)){
            // Ensure to display only products with available quantity
            if ($Rows['ProductQuantity'] > 0) {
		echo '	
		<div class="col-sm-4 col-lg-4 col-md-4">
             <div class="thumbnail">
				<h4 style="text-align: center;">'.$Rows[2].'</h4>
                <img style="border: 2px solid gray; border-radius: 10px; height: 229px; width: 298px;" src="data:image;base64,'.$Rows[7].'" alt="">
                <div class="caption">
					<p><strong>Product Name:</strong> '.$Rows[1].'</p>
					<p><strong>Size Available:</strong> '.$Rows[3].'</p>
					<p><strong>Product Type:</strong> '.$Rows[9].'</p>
